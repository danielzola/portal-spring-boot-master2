    ...
    j = function(d) {
        ...
        e.prototype = {
            ...
            _fnDrawCallback: function() {
                for (var a =
                        this.s.dt.aoColumns, b = this.dom.buttons, c = this.s.aoGroups, f, g = 0, h = b.length; g < h; g++) f = b[g], f.__columnIdx !== k && d("input", f).prop("checked", a[f.__columnIdx].bVisible);
                b = 0;
            ...
            _fnAddButtons: function() {
                ...
                if (-1 === d.inArray("all", this.s.aiExclude))
                    for (var c =
                            1, f = b.length; c < f; c++) - 1 === d.inArray(c, this.s.aiExclude) && (a = this._fnDomColumnButton(c), a.__columnIdx = c, this.dom.buttons.push(a));
            ...
            _fnDomColumnButton: function(a) {
                ...
                return d("<li " + (f.bJUI ? 'class="ui-button ui-state-default"' : "") + '><label><input type="checkbox" /><span>' +
                    ...
                    if ("li" !== c.target.nodeName.toLowerCase() && ("input" == c.target.nodeName.toLowerCase() || null === b.s.fnStateChange)) e = !e;
        ...
        e.fnRebuild =
            function(a) {
                ...
                for (var c = 0, f = e.aInstances.length; c < f; c++)("undefined" == typeof a || b == e.aInstances[c].s.dt.nTable) && e.aInstances[c].fnRebuild()
            };
        e.defaults = {
            active: "click",
