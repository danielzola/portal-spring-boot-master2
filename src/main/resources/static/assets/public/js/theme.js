    ...
    $(window).on('scroll', function () {
        ...
        if ($('.stricked-menu').length) {
            ...
            if ($(window).scrollTop() > headerScrollPos) {
                ...
                $('.header-logo').addClass('header-logo-stick');
                $('.header-title').addClass('header-title-stick');
            } else if ($(this).scrollTop() <= headerScrollPos) {
                stricky.removeClass('stricky-fixed');
                $('.header-logo').removeClass('header-logo-stick');
                $('.header-title').removeClass('header-title-stick');
            }
        }
        $("a[href='https://maps.google.com/maps?ll=-1.72092,116.54786&z=5&t=m&hl=en-US&gl=US&mapclient=apiv3']").hide();
  	    $("div.gm-style-cc").hide();
        OnePageMenuScroll();
    });
