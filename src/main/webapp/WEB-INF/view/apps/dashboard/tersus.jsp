	...
	<body class="theme-body">
			...
			<div class="theme-content">
				...
				<div class="content-area">
					<div id="toparea">
						<div class="page-level-filteration">
						      ...
						      <div class="filteration-text" style="margin:20px 0px 30px 0px;">
					      		<div class="row col-lg-12">
					      			<div class="col-lg-12 col-md-12">
					            		<div style="font-weight:normal !important; margin-top:5px;">
											<div class="row">
												<div class="col-lg-3 col-md-3">
													<div class="form-group">
														<label style="color:#fff !important;">Filter Pencarian</label>
														<select class="form-control" id="txt_by" name="txt_by">
															<option value="01">Kata Kunci</option>
															<option value="02">Unit Kerja</option>
															<option value="03">Provinsi</option>
															<option value="04">Bidang Usaha</option>
														</select>
													</div>
												</div>
												<div class="col-lg-3 col-md-3">
													<div class="form-group">
														<label style="color:#fff !important;"> &nbsp;</label>
														<div>
												...
												<div class="col-lg-3 col-md-3">
													<div class="form-group">
														<label style="color:#fff !important;"> &nbsp;</label>
														<div>
														<button type="button" onclick="submitFilter()" class="btn btn-sm btn-primary">Submit</button>
														</div>
													</div>
												</div>
											</div>					            		
					...
					<div class="grid-stack gs-area">
								...
								<div class="console-panel-body-noscroll">
									<div class="console-stats text-center">
										<div class="row">
											<div class="col-lg-6">
												<div class="stats-num">
													<span onclick="bypemilik('1')" id="DsbTersusJml1" style="font-size:30px; cursor:pointer;" class="badge badge-success"></span>
												</div>
												<div style="margin-top:10px;">TERSUS</div>											
											</div>
											<div class="col-lg-6">
												<div class="stats-num">
													<span onclick="bypemilik('3')" id="DsbTersusJml2" style="font-size:30px; cursor:pointer;" class="badge badge-primary"></span>
												</div>
						...
						<div class="grid-stack-item" data-gs-x="4" data-gs-y="37" data-gs-width="4" data-gs-height="16" data-gs-min-height="10"  data-gs-min-width="4">
							<div class="console-panel grid-stack-item-content">
								<div class="console-panel-header">
									<div class="cph-left">
										<h5>Data TERSUS Per Status Aktif</h5>
									</div>
									<div class="cph-right">
										<ul class="top-header-btns">
											<li><a class="switch-full" href="#" title="Expand Panel To Full Screen"    data-rel="tooltip"> <i class="icon dripicons-expand-2"></i></a></li>
						...
						<div class="grid-stack-item" data-gs-x="8" data-gs-y="37" data-gs-width="4" data-gs-height="16" data-gs-min-height="10"  data-gs-min-width="4">
							<div class="console-panel grid-stack-item-content">
								<div class="console-panel-header">
									<div class="cph-left">
										<h5>Data TUKS Per Status Aktif</h5>
									</div>
									<div class="cph-right">
										<ul class="top-header-btns">
											<li><a class="switch-full" href="#" title="Expand Panel To Full Screen"    data-rel="tooltip"> <i class="icon dripicons-expand-2"></i></a></li>
		...
		<script>			
		   ...
		   '</div>';
			...
			loader.add('portgreen', '${baseUrl}/assets/public/images/icon/port-green.webp');
			...
			function loadGisPelabuhan(what,key){
				...
				loader.load(function(loader, resources) {
					var textures = [resources.port.texture,resources.portgreen.texture];
								...
								if (firstDraw) {
									...
									map.on('click', function(e) {
										...
										if (marker) {
											focus = marker;
											if(layerPort==1){
												L.popup({className: 'pixi-popup'}).setLatLng(e.latlng).setContent('<div style="padding:5px 5px 5px 5px; width:200px; min-width:200px;"><br><div style="font-size:16px !important; color:#3B5874;"><b><span style="color:#2F4099;">'+marker.legend.toString()+'</span></b></div><div style="padding-bottom:10px;">'+marker.tersus_tuks.toString()+'</div><button onclick="openDetail(\'tersus\', \''+marker.id_tersus+'\')" class="btn btn-sm btn-primary"><i class="fa fa-info-circle"></i> Informasi</button></div></div>').openOn(map);
											}
											redraw = true;
										}
			...
			xmlhttp.open("GET", "/dashboard/tersustuks/jumlah", true);
			xmlhttp.send();						  
			...
			function chartKapal(what,key){
			    ...
			    myChart1 = new Chart(ctx, {
			         type: 'doughnut',
			         data: {
			             labels: labelCountBidang,
			             datasets: [{
			                 label: '',
			                 data: dataCountBidang,
			                 backgroundColor: [
			                     '#afd6fa',
			                     '#82b1dd',
			                     '#6ea1cf',
			    ...
			    myChart2 = new Chart(ctx2, {
			         type: 'doughnut',
			         data: {
			             labels: labelGroupActiveTersus,
			             datasets: [{
			                 label: 'TERSUS',
			                 data: dataGroupActiveTersus,
			                 backgroundColor: [
			                     '#96DC08',
			                     '#DC143C'
			                 ]
			    ...
			    myChart3 = new Chart(ctx3, {
			         type: 'doughnut',
			         data: {
			             labels: labelGroupActiveTuks,
			             datasets: [{
			                 label: 'TUKS',
			                 data: dataGroupActiveTuks,
			                 backgroundColor: [
			                     '#96DC08',
			                     '#DC143C'
			                 ]
