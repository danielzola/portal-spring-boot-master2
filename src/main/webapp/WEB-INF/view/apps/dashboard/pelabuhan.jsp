	...
	<body class="theme-body">
			...
			<div class="theme-content">
				...
				<div class="content-area">
					...
					<div class="grid-stack gs-area">
							...
							<div class="console-panel grid-stack-item-content  console-no-header">
								...
								<div class="console-panel-body-noscroll">
									<div class="console-stats text-center">
										<div class="stats-num">
											<span id="DsbPelabuhanJml" style="font-size:30px;" class="badge badge-success"></span>
										</div>
										<div style="margin-top:10px;">Data Pelabuhan</div>
									</div>
								</div>
							</div><!-- Console Panel -->
						</div>
						...
						<div class="grid-stack-item" data-gs-x="0" data-gs-y="19" data-gs-width="12" data-gs-height="18" data-gs-min-height="10"  data-gs-min-width="4">
							<div class="console-panel grid-stack-item-content">
								<div class="console-panel-header">
									<div class="cph-left">
										<h5>Data Pelabuhan Per Propinsi</h5>
						...
						<div class="grid-stack-item" data-gs-x="0" data-gs-y="37" data-gs-width="8" data-gs-height="18" data-gs-min-height="10"  data-gs-min-width="4">
							<div class="console-panel grid-stack-item-content">
								<div class="console-panel-header">
									<div class="cph-left">
						...
						<div class="grid-stack-item" data-gs-x="8" data-gs-y="37" data-gs-width="4" data-gs-height="18" data-gs-min-height="10"  data-gs-min-width="4">
							<div class="console-panel grid-stack-item-content">
								<div class="console-panel-header">
									<div class="cph-left">
										<h5>Kapal Terdaftar</h5>
										<span>10 Pelabuhan Terbanyak</span>
									</div>
									<div class="cph-right">
										<ul class="top-header-btns">
											<li><a class="switch-full" href="#" title="Expand Panel To Full Screen"    data-rel="tooltip"> <i class="icon dripicons-expand-2"></i></a></li>
		...
		<script>			
		   ...
		   '</div>';
			...
			xmlhttp.onreadystatechange = function() {
			  if (this.readyState == 4 && this.status == 200) {
				  $('#DsbPelabuhanJml').html(this.responseText);
			  }
			};
			xmlhttp.open("GET", "/dashboard/pelabuhan/jumlah", true);
			xmlhttp.send();						  
			...
			function loadsatkertable(what, key){
				...
				satkertable = $('#satkertable').DataTable({
			            "ajax": {
			                "url": "/dashboard/pelabuhan/satker",
			                "type": "POST",
			...
			xmlhttp.open("GET", "/dashboard/pelabuhan/propinsi", true);
			xmlhttp.send();						  
			...
			function chartKapal(what,key){
				if(myChart1 != null){
	    	  	...
	    	  	$.post("/dashboard/pelabuhan/kapal",{what:what, key:key},function(myObj){
				    var labelkapal = [];
				    var valuekapal = [];
	    	  		for(var i=0; i<myObj.data.length; i++){
				    	 labelkapal.push(myObj.data[i].nama_pelabuhan);
				    	 valuekapal.push(myObj.data[i].jml_kapal);	    	  			
	    	  		}
