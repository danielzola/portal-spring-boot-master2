...
<html lang='en'>
	...
	<body class="theme-body">
							...
							<div class="console-panel grid-stack-item-content">
								...
								<div class="console-panel-body no-padding">
									<div class="table-container">
										<table class="table table-striped datatable console-table" id="roletable">
		...
		function addRole(){
			document.location = '/users/role/form/0';
		}
		
		function editRole(id){
			document.location = '/users/role/form/'+id;
		}
		...
		function deleteRole(id){
			swal({
				...
				if(isConfirm){
					...
					$.post("/users/role/delete",{id : id.toString()},function(data){
						if(data.code=='01'){
							swal({
								title: "Hak Akses",
