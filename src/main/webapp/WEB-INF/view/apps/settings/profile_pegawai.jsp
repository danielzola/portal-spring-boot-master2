			...
			<div class="theme-content">
				...
				<div class="content-area">
					...
					<div class="grid-stack gs-area">
						<div class="grid-stack-item" data-gs-x="0" data-gs-y="10" data-gs-width="12" data-gs-min-height="26" data-gs-height="26" data-gs-min-width="6">
			...
			$('#frmPegawai').submit(function(){
				swal({
					...
					if(isConfirm){
						...
						$.post("/settings/profile/save",parseData,function(data){
							if(data.code=='01'){
								swal({
									title: "Profil",
